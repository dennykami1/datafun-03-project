...
and saves it to a local file named global_population.csv in a folder named fetched_data.
...
def main():
    ...
    fetch_csv_file(fetched_folder_name, "global_population.csv", csv_url)
