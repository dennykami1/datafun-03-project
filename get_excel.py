...
def main():
    ...
    """
    excel_url = 'https://www.ncei.noaa.gov/data/oceans/archive/arc0132/0185113/1.1/data/0-data/Annual%20Penguin%20Census%201977-2015%20v1_0.xlsx'
    logger.info("Starting Excel fetch demonstration...")
    fetch_excel_file(fetched_folder_name, "Annual_Penguin_Census.xlsx", excel_url)
