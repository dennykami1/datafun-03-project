"""
This file fetches a text file of The Great Gatsby from the web 
and saves it to a local file named great_gatsby in a folder named example_data.
...
def fetch_txt_file(folder_name: str, filename: str, url: str) -> None:
    ...
    Example:
        fetch_txt_file("data", great_gatsby.txt, "https://example.com/romeo.txt")
    """
    if not url:
...
def main():
    ...
    """
    txt_url = 'https://www.gutenberg.org/cache/epub/64317/pg64317.txt'
    logger.info("Starting text fetch demonstration...")
    fetch_txt_file(fetched_folder_name, "great_gatsby.txt", txt_url)
